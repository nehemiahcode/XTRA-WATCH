...
export default function Testimonial() {
  ...
  return (
    <section className=" py-10 w-full px-4 md:px-10 lg:px-16">
      ...
      <Typography
        style={
          " text-center text-[0.98rem] md:text-base leading-loose md:leading-relaxed  py-2 text-gray-800 dark:text-white"
        }
      >
      ...
      <div className="bg-white dark:bg-slate-900 rounded-md mx-auto shadow-lg w-[95%] xl:w-[40%] lg:w-[45%] md:w-[70%] sm:w-[80%]">
        ...
        >
          {Testimonial.map((items, index) => (
            ...
            >
              <blockquote className="text-center text-[0.98rem] md:text-base leading-loose md:leading-relaxed   font-medium py-3 text-gray-800 dark:text-white">
                &quot;I don&apos;t always clop, but when I do, it&apos;s because
                of pear watch. Pear watch has really helped me. I STRONGLY
                recommend pear watch to EVERYONE interested in fashion &amp;
                tech! This is simply unbelievable!&quot;
              </blockquote>
      ...
      <div className=" w-full flex items-center my-2 justify-center gap-5">
        <Ripples className=" rounded-full active:scale-110">
          <button
            ...
            className=" text-lg text-white flex items-center active:scale-110 cursor-default md:cursor-poin>ter justify-center bg-blue-600 rounded-full p-3 h-[40px] w-[40px]"
            type="button"
          >
            <GrPrevious />
          </button>
